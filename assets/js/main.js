...
// ============================================
// RENDER VIDEOS - 10 latest drops from YouTube
// ============================================
function renderVideos() {
  const container = document.getElementById('video-container');
  if (!container || !siteData) return;

  // Get all releases with YouTube embeds
  const videos = [];

  // Add specific known videos
  const knownVideos = [
    ...
    { title: "PEHLE JAISA", artist: "Abir", embed: "https://www.youtube.com/embed/PLACEHOLDER_PEHLE", id: "PLACEHOLDER" },
    { title: "SMACK", artist: "Slay", embed: "https://www.youtube.com/embed/PLACEHOLDER_SMACK", id: "PLACEHOLDER" },
    { title: "WASSUP", artist: "Slay", embed: "https://www.youtube.com/embed/PLACEHOLDER_WASSUP", id: "PLACEHOLDER" },
  ];

  container.innerHTML = knownVideos.slice(0, 10).map(v => `
    <div class="relative">
...
function renderSocials() {
  ...
  const iconMap = {
    ...
    soundcloud: '<svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M1.175 12.225c-.051 0-.094.046-.101.1l-.233 2.154.233 2.105c.007.058.05.098.101.098.05 0 .09-.04.099-.098l.255-2.105-.27-2.154c-.009-.06-.052-.1-.084-.1z"/></svg>'
  };
